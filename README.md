...
| Image | Description |
|-------|-------------|
| `ghcr.io/<your-username>/maxtext-tpu-pretraining:stable` | TPU pre-training with stable JAX |
| `ghcr.io/<your-username>/maxtext-tpu-pretraining:nightly` | TPU pre-training with nightly JAX |
| `ghcr.io/<your-username>/maxtext-tpu-posttraining:stable` | TPU post-training (SFT/GRPO) with stable JAX |
| `ghcr.io/<your-username>/maxtext-tpu-posttraining:nightly` | TPU post-training with nightly JAX |

## Pull

```bash
# TPU pre-training (stable JAX)
docker pull ghcr.io/<your-username>/maxtext-tpu-pretraining:stable

# TPU post-training (stable JAX)
docker pull ghcr.io/<your-username>/maxtext-tpu-posttraining:stable
```
...
```bash
# Using crane
crane copy ghcr.io/<your-username>/maxtext-tpu-pretraining:stable \
  your-registry.example.com/maxtext-tpu-pretraining:stable

# Using skopeo
skopeo copy \
  docker://ghcr.io/<your-username>/maxtext-tpu-pretraining:stable \
